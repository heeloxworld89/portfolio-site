    ...
    <div className="row mb--50" id="deployment">
      <div className="col-12">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '10px', marginBottom: '40px' }}>
          {[
            { status: 'Vertical 1 · Very Early Stage Ablation', sector: 'E-Commerce', note: 'Achieved four-figure revenue and 500+ customers with fully autonomous Zero-CAC unit economics. Kept at small scale due to AI governance constraints.' },
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '12px', marginBottom: '40px' }}>
          {[
            ...
            { val: '500+', lbl: 'Early Stage Customers', sub: 'Four-figure autonomous revenue (Zero-CAC)' },
        ...
        <div className="content mt--30">
          ...
          <p style={{ fontSize: "14px", color: "#878e99", marginBottom: "20px" }}>Initial OXIMO pipeline deployed. Achieved four-figure revenue with fully autonomous Zero-CAC unit economics at very small scale. Cannot go full scale yet due to AI governance constraints.</p>
