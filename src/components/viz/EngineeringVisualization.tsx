...
export default function EngineeringVisualization() {
  return (
    <div className="evz">
      ...
      {/* ══ SELF-HIRING ═════════════════════════════════════════════ */}
      <div className="evz-block">
        <h4 className="evz-h">Hiring, Mid-Task</h4>
        <p className="evz-s">
      ...
      <div className="evz-two">
        <div className="evz-block" style={{ marginBottom: 0 }}>
          ...
          <p className="evz-note">
            This is what the Black Bloxie study measured. Removing an embedded system does not migrate it —{' '}
            <strong>its accumulated memory goes with it, and output fell 91%.</strong>
          </p>
        </div>
