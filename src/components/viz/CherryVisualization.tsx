...
const compare: { k: string; std: string; cherry: string }[] = [
  ...
  { k: 'What it forgets when it learns', std: 'Catastrophic forgetting on retraining', cherry: 'Built on ORMAS, which retained 94.6% vs 47.3%' },
    ...
    <div className="cvz">
      ...
      <div className="cvz-table">
        <div className="cvz-tr is-head">
          ...
          <div className="cvz-th chr">Project Cherry (design)</div>
        </div>
        {compare.map((r) => (
